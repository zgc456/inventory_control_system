...
public class KafkaListener {
   ...
   private MessageService messageService;
     ...
     * @param message
     */
    @org.springframework.kafka.annotation.KafkaListener(id="client_one",topics = "backstageControlSystemMessage")
    public void receive(String message) {
        ...
        try {
            ...
            System.out.println("接受消息格式不对");
        }
    }
    //kafka监听器 topics 订阅
    @org.springframework.kafka.annotation.KafkaListener(id="client_two",topics = "test1")
